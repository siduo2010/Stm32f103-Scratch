...
static void ADC1_Mode_Config(void)
{
	...
	DMA_InitStructure.DMA_PeripheralBaseAddr = ADC1_DR_Address;//(u32)&ADC1->DR;	 //ADC地址
...
float ReadLightsevro(char pin)
{
	...
	{
		case 7:
			value = (float) ADC_ConvertedValue[3]/4096*100.0;
		break;
		
		case 8:
			value = (float) ADC_ConvertedValue[4]/4096*100.0;
		break;
		
		case 11:
			value = (float) ADC_ConvertedValue[0]/4096*100.0;
		break;
	}
...
float ReadSoundsevro(char pin)
{
	...
	switch(port)
	{
		...
		case 11:
			value = (float) ADC_ConvertedValue[1]/4096*100.0;
		break;
	}
...
float ReadPotentionmeterRsevro(char pin)
{
	...
	switch(port)
	{
		...
		case 11:
			value = (float) ADC_ConvertedValue[2]/4096*100.0;
		break;
	}
